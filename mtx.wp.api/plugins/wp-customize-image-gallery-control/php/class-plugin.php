...
class Plugin {
	...
	public function register_styles( \WP_Styles $wp_styles ) {
		...
		$src = get_bloginfo('template_url') . '/plugin/wp-customize-image-gallery-control/css/customize-image-gallery-control.css';
	...
	public function register_scripts( \WP_Scripts $wp_scripts ) {
		$handle = 'customize-image-gallery-control';
		$src = get_bloginfo('template_url') . '/plugin/wp-customize-image-gallery-control/js/customize-image-gallery-control.js';
